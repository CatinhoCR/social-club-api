...
function updateUser(req, res) {
  ...
  // Need to check if password did change, then it, wrap this code below in a bcrypt.hash function
  // See: https://stackoverflow.com/questions/34326162/nodejs-updating-user-bcrypt-password-doesnt-get-hashed
